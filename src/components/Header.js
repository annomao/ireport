    ...
    <nav className="flex items-center justify-between flex-wrap bg-base p-6 fixed w-full z-10 top-0">
		...
		<div className="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden lg:block pt-6 lg:pt-0" id="nav-content">
			<ul className="list-reset lg:flex justify-end flex-1 items-center">
				<li className="mr-3">
					<a className="inline-block py-2 px-4 text-white no-underline hover:text-gray-400">Log In</a>
				</li>
				<li className="mr-3">
					<a className="inline-block no-underline text-white hover:text-gray-400 py-2 px-4">Sign Up</a>
				</li>
			</ul>
		</div>
	</nav>
